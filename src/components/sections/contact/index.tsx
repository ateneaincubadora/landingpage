...
export default function Contact() {
  return (
    <section
      id="contact"
      className="overflow-x-hideen relative flex  items-center justify-center overflow-hidden bg-grayish-light bg-contact-background bg-cover   bg-no-repeat px-2 pb-6 pt-32 lg:h-screen lg:px-28 lg:pb-0 lg:pt-[6.125rem] dt:pt-0"
    >
